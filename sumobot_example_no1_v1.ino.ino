...
/***************************************************************************
 Example Code of a particular sumobot with 2 line trackers and 2 front obstacle sensors
 using ultrasonic and IR distance sensors
